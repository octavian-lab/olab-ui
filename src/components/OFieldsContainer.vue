<template>
  <div id="o-fields-container" :class="['grid formgrid p-fluid', { striped: striped }]">
    <slot />
  </div>
...
#o-fields-container {
  ...
  .o-field {
    ...
    [class*='p-input']:not(.p-chips-multiple-container,[class*='p-inputswitch']) {
    ...
    &:first-child:not(i, .p-inputgroup, .p-calendar .p-chips-token, &[class*='col-']) {
      width: 100%;
    }
