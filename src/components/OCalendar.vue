    ...
    generateOptions() {
      return [
        ...
        },
        {
          ...
          date: {
            from: this.getMidNight(this.getStartOf(this.addPeriod(moment(), -1, 'weeks'), 'isoweek')).toDate(),
            to: this.getMidNight(this.getEndOf(this.addPeriod(moment(), -1, 'weeks'), 'isoweek')).toDate()
          }
        },
        {
          value: 5,
        ...
        },
        {
          ...
          updateDate(value) {
            return {
              ...this,
              date: {
                from: this.getStartOf(this.addPeriod(moment(), -value, 'months'), 'month').toDate(),
